...
wd.cdf.helper = {
  ...
  httpUrlToWebSockeUrl: function( url ) {
...
wd.cdf.endpoints = {
  ...
  getPluginWebsocketBase: function( plugin ) { return wd.cdf.helper.httpUrlToWebSockeUrl(wd.cdf.endpoints.getWebapp()) + plugin + "/websocket"; },
